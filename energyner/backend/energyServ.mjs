...
import { calcularHuellaCarbono } from './11-04class_api_navegador_hc.mjs';
...
app.post('/api/consumo-energetico', (req, res) => {
    ...
    console.log("1.2 - Calculo resuelto consumo-energetico ")
});
...
app.post('/api/produccion-solar', (req, res) => {
    ...
    console.log("2.2 - Calculo resuelto produccion-solar ")
});
